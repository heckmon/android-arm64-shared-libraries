...
cd ..
rm -rf $ME
fetch_source $ME.tar.gz https://nodejs.org/dist/v24.4.1/node-v24.4.1.tar.gz
...
export CC_host=$HOST_GCC_DIR/gcc
export CXX_host=$HOST_GCC_DIR/g++
export AR_host=$HOST_GCC_DIR/gcc-ar
export RANLIB_host=$HOST_GCC_DIR/gcc-ranlib
